...
*/
        ...
        private static Query genericFunctionFilter(Function function, Context context) {
            ...
            @SuppressWarnings("unchecked") final Input<Boolean> condition = (Input<Boolean>) ctx.add(function);
            @SuppressWarnings("unchecked") final Collection<? extends LuceneCollectorExpression<?>> expressions = ctx.expressions();
